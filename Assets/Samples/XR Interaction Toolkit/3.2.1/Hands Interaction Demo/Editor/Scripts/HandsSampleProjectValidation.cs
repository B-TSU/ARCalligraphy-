    ...
    static class HandsSampleProjectValidation
    {
        ...
        static readonly List<BuildValidationRule> s_BuildValidationRules = new List<BuildValidationRule>
        {
            ...
            new BuildValidationRule
            {
                ...
                Category = k_Category,
                CheckPredicate = () => HasSampleImported(k_HandsPackageName, k_HandVisualizerSampleName),
                FixIt = () =>
                {
                ...
                FixItAutomatic = true,
                Error = !HasSampleImported(k_HandsPackageName, k_HandVisualizerSampleName),
            },
            new BuildValidationRule
            {
                ...
                Category = k_Category,
                CheckPredicate = () => HasSampleImported(k_XRIPackageName, k_StarterAssetsSampleName),
                FixIt = () =>
                {
                ...
                FixItAutomatic = true,
                Error = !HasSampleImported(k_XRIPackageName, k_StarterAssetsSampleName),
            },
            new BuildValidationRule
            {
        ...
        static bool HasSampleImported(string packageName, string sampleDisplayName)
        {
            try
            {
            ...
            {
                // If we can't check, assume not imported to be safe
            }
            return false;
        }
        ...
        {
            // Simplified version check - just check if sample is imported
            if (HasSampleImported(packageFolderName, sampleDisplayName))
                return string.Empty;
